    ...
    # Version Label
        ...
        if len(self.openTickets) > 15:
            ...
            for t in self.openTickets:
                ...
                if datetime.now() > rawOpenDate + timedelta(days = 14):
                    print("here")
                    frame1 = Frame(root,bg=self.color,width=374,height=264,padx=3,pady=3, highlightbackground="red", highlightcolor="red", highlightthickness=3.5, bd=0)
                    frame1.grid(row=rcounter, column=ccounter, padx=5,pady=3)
                elif datetime.now() > rawOpenDate + timedelta(days = 10):
                    frame1 = Frame(root,bg=self.color,width=374,height=264,padx=3,pady=3, highlightbackground="orange", highlightcolor="orange", highlightthickness=2.5, bd=0)
                    frame1.grid(row=rcounter, column=ccounter, padx=5,pady=3)
                elif datetime.now() > rawOpenDate + timedelta(days = 5):
                    frame1 = Frame(root,bg=self.color,width=374,height=264,padx=3,pady=3, highlightbackground="green", highlightcolor="green", highlightthickness=2.5, bd=0)
                    frame1.grid(row=rcounter, column=ccounter, padx=5,pady=3)
        ...
        # if less than 16 tickets
            ...
            for t in self.openTickets:
                ...
                if datetime.now() > rawOpenDate + timedelta(days = 14):
                    print("here")
                    frame1 = Frame(root,bg=self.color,width=374,height=354,padx=3,pady=3, highlightbackground="red", highlightcolor="red", highlightthickness=3.5, bd=0)
                    frame1.grid(row=rcounter, column=ccounter, padx=5,pady=3)
                elif datetime.now() > rawOpenDate + timedelta(days = 10):
                    frame1 = Frame(root,bg=self.color,width=374,height=354,padx=3,pady=3, highlightbackground="orange", highlightcolor="orange", highlightthickness=2.5, bd=0)
                    frame1.grid(row=rcounter, column=ccounter, padx=5,pady=3)
                elif datetime.now() > rawOpenDate + timedelta(days = 5):
                    frame1 = Frame(root,bg=self.color,width=374,height=354,padx=3,pady=3, highlightbackground="green", highlightcolor="green", highlightthickness=2.5, bd=0)
                    frame1.grid(row=rcounter, column=ccounter, padx=5,pady=3)
